...
At the start of every session, read Codex/smes/fashion-stores/SME.md before making any store recommendations, updating storeSearch.ts, or modifying the Ask Nomi system prompt.
